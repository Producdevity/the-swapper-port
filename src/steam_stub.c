...
bool SteamInternal_GameServer_Init_V2(uint32_t ip, uint16_t steam_port, uint16_t game_port,
                                      uint16_t query_port, int32_t server_mode, const char *version,
                                      void *error_message) {
    (void)ip;
    (void)steam_port;
    (void)game_port;
...
bool SteamEncryptedAppTicket_BDecryptTicket(const void *encrypted_ticket,
                                            uint32_t encrypted_ticket_size, void *decrypted_ticket,
                                            uint32_t *decrypted_ticket_size, const void *key,
                                            int key_size) {
...
uint32_t SteamEncryptedAppTicket_GetTicketSteamID(const void *ticket, uint32_t ticket_size,
                                                  void *steam_id) {
    (void)ticket;
    (void)ticket_size;
    (void)steam_id;
